...
char column_name_in_sheets[][6] = { "X", "Y", "Z" };                                  /*1. The Total no of column depends on how many value you have created in Script of Sheets;2. It has to be in order as per the rows decided in google sheets*/
String Sheets_GAS_ID = "AKfycbyLg0tHKG3B9bRdxU0mS8Lb033hBNOgBbfQwJS1hVmF_mlf2AtDrjr221IhNYGamzNn5A"; /*This is the Sheets GAS ID, you need to look for your sheets id*/
